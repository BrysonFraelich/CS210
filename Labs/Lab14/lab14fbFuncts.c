...
int readData(int attempts[], int yards[], int touchdowns[]) {
    ...
    // Open file
    printf("Opening file \"fbData.txt\".\n"); // C:\Users\C22Bryson.Fraelich\CLionProjects\Labs\Lab14
//    inFile = fopen("C:/Users/C22Bryson.Fraelich/CLionProjects/Labs/Lab14/fbData.txt", "r"); // use this for working in CLion (comment when you submit)
